...
/**
 * MySecondSeleniumTests takes us all the way up to chapter 12
 * This gets refactored in chapter 12
 * 
 * @author Alan
 *
 */

public class MySecondSeleniumTestsFinal {
	...
	public void typeInASearchTermAndAssertThatHomePageTextIsPresentInSource(){
		...
		assertTrue(pageSource.contains("<em>Selenium Remote-Control</em> Selenium RC comes in two parts. A server which automatically".toLowerCase()));
