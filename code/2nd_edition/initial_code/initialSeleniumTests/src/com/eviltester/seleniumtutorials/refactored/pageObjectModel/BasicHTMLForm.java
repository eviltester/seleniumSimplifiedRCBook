...
public class BasicHTMLForm {
	...
	public void typeFilename(String fileName) {
		// type used to work for most browsers
		// browsers are slowly tightening up their
		// security models to make file manipulation
		// harder
		//selenium.type(FILENAME_LOCATOR, fileName);
		selenium.attachFile(FILENAME_LOCATOR, fileName);
		
		// for chrome you should really use attachFile
		//selenium.attachFile(FILENAME_LOCATOR, fileName);
	}
